...
use crate::server::messages::peer::PeerAddress;
...
impl Dispatcher {
    ...
    async fn on_peer_request(&mut self, username: &str, request: PeerRequestPacket) {
        ...
        self.push_to_queue(username.to_string(), request);
    ...
    fn push_to_queue(&mut self, username: String, request: PeerRequestPacket) {
