...
<svg height="18" width="18" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="wifi" role="img"
     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="svg-inline--fa fa-wifi fa-w-20 fa-3x"><path
        fill="currentColor"
...
<svg height="18" width="18" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="wifi-slash" role="img"
     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="svg-inline--fa fa-wifi-slash fa-w-20 fa-3x"><path
        ...
        {/if}
        <span class="status-element">
            <svg height="18" width="18" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="link"
                 role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                 class="svg-inline--fa fa-link fa-w-16 fa-3x"><path fill="currentColor"
                                                                    ...
                                                                    class=""></path></svg>
            {currentNumberOfConnections}/{maxNumberOfConnections}
            </span>
        <span class="status-element">
              <svg height="18" width="18" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="arrow-down"
                   ...
                   class="svg-inline--fa fa-arrow-down fa-w-14 fa-3x">
                    <path fill="currentColor"
                          ...
                          class=""></path></svg>
            {numberOfUsersDownload} users ({downloadRate} B/s)
        </span>
        <span class="status-element">
          <svg height="18" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="arrow-up"
            ...
            {numberOfUsersUpload} users ({uploadRate} B/s)
    </span>
    </button>
</div>
